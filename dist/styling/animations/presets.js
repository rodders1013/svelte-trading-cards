 ...
 */
export function getKeyframes(type) {
    if (type === 'none')
        return '';
 ...
 */
export function getAnimationName(type, direction = 'clockwise') {
    if (type === 'none')
        return 'none';
 ...
 */
export function getDefaultEasing(type) {
    if (type === 'none')
        return 'ease-in-out';
 ...
 */
export function supportsDirection(type) {
    if (type === 'none')
        return false;
