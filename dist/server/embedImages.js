 ...
 */
async function fetchImageAsDataURI(url, timeout) {
    try {
 ...
 * - url(...) in CSS
 */
function findImageReferences(svgString) {
    const matches = [];
 ...
 * ```
 */
export async function embedImages(svgString, options = {}) {
    ...
    await processWithConcurrency(uniqueUrls, async (url) => {
 ...
 */
export function hasExternalImages(svgString) {
