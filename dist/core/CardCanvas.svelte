<script lang="ts" module>
	import type { CardTemplate, CardData, ContainerContext } from '../types';
...
<script lang="ts">
	import { CARD_WIDTH, CARD_HEIGHT, CARD_RADIUS } from '../types';
	import { getAnimationCSS } from '../styling/animations';
