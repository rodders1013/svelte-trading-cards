 ...
 */
export declare const BRAND_FONTS: BrandFont[];
/**
 * Get brand fonts available for a specific dataset.
 */
export declare function getBrandFontsForDataset(datasetId: DatasetId): BrandFont[];
/**
 * Get brand font options formatted for dropdown UI.
 */
export declare function getBrandFontOptions(datasetId: DatasetId): Array<{
    value: string;
    label: string;
}>;
