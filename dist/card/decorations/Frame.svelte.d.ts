import { z } from 'zod';
export declare const FrameStyleSchema: z.ZodEnum<{
    simple: "simple";
    ornate: "ornate";
    "art-deco": "art-deco";
    celtic: "celtic";
...
export declare const FrameSizeSchema: z.ZodEnum<{
    sm: "sm";
    md: "md";
    lg: "lg";
}>;
export type FrameSize = z.infer<typeof FrameSizeSchema>;
export declare const FramePropsSchema: z.ZodObject<{
    ...
    corners: z.ZodDefault<z.ZodBoolean>;
    edges: z.ZodDefault<z.ZodBoolean>;
...
type $$ComponentProps = FrameProps & {
