import { z } from 'zod';
export declare const ListStyleSchema: z.ZodEnum<{
    none: "none";
    bullet: "bullet";
    numbered: "numbered";
    dash: "dash";
...
export declare const ListPropsSchema: z.ZodObject<{
    ...
    bulletColor: z.ZodOptional<z.ZodString>;
    bulletSize: z.ZodOptional<z.ZodNumber>;
    ...
    overflowText: z.ZodDefault<z.ZodString>;
    overflowColor: z.ZodOptional<z.ZodString>;
