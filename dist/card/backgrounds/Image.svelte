<script lang="ts" module>
	...
	import { BuiltInShapeSchema } from '../../styling/shapes/types.js';
	import { FilterConfigSchema, ImageTransformConfigSchema } from '../../styling/filters/types.js';
...
<script lang="ts">
	...
	import { AnimationWrapper } from '../../styling/animations/index.js';
	import { EffectWrapper } from '../../styling/effects/index.js';
	import { FilterWrapper } from '../../styling/filters/index.js';
	import BorderRenderer from '../../styling/BorderRenderer.svelte';
	import HolographicWrapper from '../../styling/HolographicWrapper.svelte';
	import { getShapeRenderData } from '../../styling/shapes/shapeUtils.js';
	import { hasActiveFilters } from '../../styling/filters/types.js';
