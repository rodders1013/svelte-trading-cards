 ...
 */
async function fetchImageAsDataURIClient(url) {
    try {
 ...
 */
async function embedImagesClient(svgString) {
 ...
 */
export function applyBleed(svgElement, options) {
 ...
 */
export function serializeSVG(svgElement, includeDeclaration = true) {
 ...
 */
export function svgToBlob(svgElement) {
    const svgString = serializeSVG(svgElement, true);
 ...
 * ```
 */
export function downloadSVG(svgElement, options = {}) {
 ...
 * ```
 */
export async function svgToPNGClient(svgElement, scale = 1, bleedMm = 0) {
    // Apply bleed if specified
 ...
 */
export async function downloadPNGClient(svgElement, options = {}) {
