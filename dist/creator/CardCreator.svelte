<script lang="ts">
	...
	import { registerComponent, Group } from '..';
	import { GradientBackground, Image, PatternBackground, SolidBackground } from '../card/backgrounds';
	import { Border } from '../card/borders';
	import { TextField, StatPanel, List } from '../card/fields';
	import { Icon } from '../card/icons';
	import type { IconData } from '../card/icons';
	import { Divider, ProgressBar, Ribbon, Frame, IconRating } from '../card/decorations';
	...
	import { downloadSVG, downloadPNGClient } from '../export/downloadSVG';
import { extractFontsFromCard, loadGoogleFonts } from '../fonts';
			...
			>
				<div class="h-full overflow-hidden">
					<PropertiesPanel
						...
						datasetId={selectedDataset as import('../presets').DatasetId}
						{previewData}
						{expandedPanels}
