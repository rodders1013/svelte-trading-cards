<script lang="ts">
	...
	import * as Accordion from '$lib/creator/ui/accordion';
	...
	import AddLayerPopover from '../popovers/AddLayerPopover.svelte';
	import AddComponentPopover from '../popovers/AddComponentPopover.svelte';
